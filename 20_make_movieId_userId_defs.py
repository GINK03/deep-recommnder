...
user_index  = {userid:index for index, userid in enumerate(df['userId'].unique().tolist()) }
movie_index = {movie:index for index, movie in enumerate(df['movieId'].unique().tolist()) }
